...
<body>
	<div class="wrapper">
		...
		<main>
			<h1>Form get</h1>
			<form action="<%=request.getContextPath() + "/formservlet"%>"
				method="get">
				...
				<div class="form-group">
					<label for="email">Email:</label> <input type="email" id="email"
						name="email" required aria-label="Email">
				</div>
			...
			<form action="<%=request.getContextPath() + "/salva2"%>" method="post">
			
				<div class="form-group">
					<label for="codiceFiscale">CF:</label> <input type="text"
				...
				<div class="form-group">
					<label for="surname">Surname:</label> <input type="text"
						id="surname" name="surname" required aria-label="Surname:">
				</div>
